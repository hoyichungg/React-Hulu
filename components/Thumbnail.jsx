...
const Thumbnail = forwardRef(({ result }, ref) => {
    const BASE_URL = process.env.NEXT_PUBLIC_API_KEY_BASE_URL
    return (
        <div ref={ref} className="m-3 group cursor-pointer transition duration-200 ease-in transform sm:hover:scale-105 hover:z-50">
            <Image
                className="rounded"
                layout="responsive"
